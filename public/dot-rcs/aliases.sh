...
alias du='/opt/homebrew/bin/gdu -mhs --apparent-size'
alias f='cdf'
...
alias y='yarn'
alias yabai-on='lunchy start yabai; lunchy start skhd; lunchy start autoraise'
...
alias gameportingtoolkit='/usr/local/bin/gameportingtoolkit-no-hud'
...
alias flush='sudo killall -HUP mDNSResponder; sudo dscacheutil -flushcache; lunchy restart coredns'
